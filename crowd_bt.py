...
def _updated_sigma_sqs(alpha, beta, mu_winner, sigma_sq_winner, mu_loser, sigma_sq_loser):
    ...
    updated_sigma_sq_winner = sigma_sq_winner * \
        max(1 + sigma_sq_winner * mult, KAPPA)
    updated_sigma_sq_loser = sigma_sq_loser * \
        max(1 + sigma_sq_loser * mult, KAPPA)
